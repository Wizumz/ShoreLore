const CACHE_NAME = 'hookr-v1.0.0';
const STATIC_CACHE_NAME = 'hookr-static-v1.0.0';
const DYNAMIC_CACHE_NAME = 'hookr-dynamic-v1.0.0';
...
function openDB() {
    return new Promise((resolve, reject) => {
        const request = indexedDB.open('HookrDB', 1);
...
self.addEventListener('push', (event) => {
    ...
    event.waitUntil(
        self.registration.showNotification('Hookr', options)
    );
});
