 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jr(r){try{return(r.startsWith("http://")||r.startsWith("https://")?new URL(r).hostname:r).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Hd(r){return(await fetch(r,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ct=new Nc("@firebase/app"),S_="@firebase/app-compat",R_="@firebase/analytics-compat",P_="@firebase/analytics",C_="@firebase/app-check-compat",x_="@firebase/app-check",N_="@firebase/auth",D_="@firebase/auth-compat",V_="@firebase/database",k_="@firebase/data-connect",M_="@firebase/database-compat",O_="@firebase/functions",L_="@firebase/functions-compat",F_="@firebase/installations",U_="@firebase/installations-compat",B_="@firebase/messaging",j_="@firebase/messaging-compat",q_="@firebase/performance",$_="@firebase/performance-compat",z_="@firebase/remote-config",G_="@firebase/remote-config-compat",H_="@firebase/storage",K_="@firebase/storage-compat",W_="@firebase/firestore",Q_="@firebase/ai",J_="@firebase/firestore-compat",Y_="firebase",X_="12.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ms=-1;class ao{constructor(e,t,n,s){this.indexId=e,this.collectionGroup=t,this.fields=n,this.indexState=s}}function rc(r){return r.fields.find(e=>e.kind===2)}function bn(r){return r.fields.filter(e=>e.kind!==2)}ao.UNKNOWN_ID=-1;class zi{constructor(e,t){this.fieldPath=e,this.kind=t}}class Os{constructor(e,t){this.sequenceNumber=e,this.offset=t}static empty(){return new Os(0,Ye.min())}}function by(r,e){const t=r.toTimestamp().seconds,n=r.toTimestamp().nanoseconds+1,s=H.fromTimestamp(n===1e9?new ce(t+1,0):new ce(t,n));return new Ye(s,F.empty(),e)}function pf(r){return new Ye(r.readTime,r.key,Ms)}class Ye{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new Ye(H.min(),F.empty(),Ms)}static max(){return new Ye(H.max(),F.empty(),Ms)}}function Oc(r,e){let t=r.readTime.compareTo(e.readTime);return t!==0?t:(t=F.comparator(r.documentKey,e.documentKey),t!==0?t:X(r.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ee{constructor(e,t,n,s,i,o,c){this.key=e,this.documentType=t,this.version=n,this.readTime=s,this.createTime=i,this.data=o,this.documentState=c}static newInvalidDocument(e){return new Ee(e,0,H.min(),H.min(),H.min(),Ue.empty(),0)}static newFoundDocument(e,t,n,s){return new Ee(e,1,t,H.min(),n,s,0)}static newNoDocument(e,t){return new Ee(e,2,t,H.min(),H.min(),Ue.empty(),0)}static newUnknownDocument(e,t){return new Ee(e,3,t,H.min(),H.min(),Ue.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(H.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Ue.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Ue.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=H.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Ee&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Ee(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hc(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ls(e)?"-0":e}}function Zf(r){return{integerValue:""+r}}function em(r,e){return xy(e)?Zf(e):Hc(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ho{constructor(){this._=void 0}}function AI(r,e,t){return r instanceof Vr?function(s,i){const o={fields:{[Vf]:{stringValue:Df},[Mf]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&qc(i)&&(i=$o(i)),i&&(o.fields[kf]=i),{mapValue:o}}(t,e):r instanceof kr?nm(r,e):r instanceof Mr?rm(r,e):function(s,i){const o=tm(s,i),c=gh(o)+gh(s.Ae);return lc(o)&&lc(s.Ae)?Zf(c):Hc(s.serializer,c)}(r,e)}function bI(r,e,t){return r instanceof kr?nm(r,e):r instanceof Mr?rm(r,e):t}function tm(r,e){return r instanceof Or?function(n){return lc(n)||function(i){return!!i&&"doubleValue"in i}(n)}(e)?e:{integerValue:0}:null}class Vr extends Ho{}class kr extends Ho{constructor(e){super(),this.elements=e}}function nm(r,e){const t=sm(e);for(const n of r.elements)t.some(s=>wt(s,n))||t.push(n);return{arrayValue:{values:t}}}class Mr extends Ho{constructor(e){super(),this.elements=e}}function rm(r,e){let t=sm(e);for(const n of r.elements)t=t.filter(s=>!wt(s,n));return{arrayValue:{values:t}}}class Or extends Ho{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function gh(r){return me(r.integerValue||r.doubleValue)}function sm(r){return zs(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sE{constructor(e,t){this.referenceDelegate=e,this.serializer=t}allocateTargetId(e){return this.lr(e).next(t=>{const n=new Hn(t.highestTargetId);return t.highestTargetId=n.next(),this.hr(e,t).next(()=>t.highestTargetId)})}getLastRemoteSnapshotVersion(e){return this.lr(e).next(t=>H.fromTimestamp(new ce(t.lastRemoteSnapshotVersion.seconds,t.lastRemoteSnapshotVersion.nanoseconds)))}getHighestSequenceNumber(e){return this.lr(e).next(t=>t.highestListenSequenceNumber)}setTargetsMetadata(e,t,n){return this.lr(e).next(s=>(s.highestListenSequenceNumber=t,n&&(s.lastRemoteSnapshotVersion=n.toTimestamp()),t>s.highestListenSequenceNumber&&(s.highestListenSequenceNumber=t),this.hr(e,s)))}addTargetData(e,t){return this.Pr(e,t).next(()=>this.lr(e).next(n=>(n.targetCount+=1,this.Tr(t,n),this.hr(e,n))))}updateTargetData(e,t){return this.Pr(e,t)}removeTargetData(e,t){return this.removeMatchingKeysForTargetId(e,t.targetId).next(()=>lr(e).delete(t.targetId)).next(()=>this.lr(e)).next(n=>(G(n.targetCount>0,8065),n.targetCount-=1,this.hr(e,n)))}removeTargets(e,t,n){let s=0;const i=[];return lr(e).ee((o,c)=>{const l=ws(c);l.sequenceNumber<=t&&n.get(l.targetId)===null&&(s++,i.push(this.removeTargetData(e,l)))}).next(()=>S.waitFor(i)).next(()=>s)}forEachTarget(e,t){return lr(e).ee((n,s)=>{const i=ws(s);t(i)})}lr(e){return Fh(e).get(uo).next(t=>(G(t!==null,2888),t))}hr(e,t){return Fh(e).put(uo,t)}Pr(e,t){return lr(e).put(vm(this.serializer,t))}Tr(e,t){let n=!1;return e.targetId>t.highestTargetId&&(t.highestTargetId=e.targetId,n=!0),e.sequenceNumber>t.highestListenSequenceNumber&&(t.highestListenSequenceNumber=e.sequenceNumber,n=!0),n}getTargetCount(e){return this.lr(e).next(t=>t.targetCount)}getTargetData(e,t){const n=$n(t),s=IDBKeyRange.bound([n,Number.NEGATIVE_INFINITY],[n,Number.POSITIVE_INFINITY]);let i=null;return lr(e).ee({range:s,index:Tf},(o,c,l)=>{const h=ws(c);Zs(t,h.target)&&(i=h,l.done())}).next(()=>i)}addMatchingKeys(e,t,n){const s=[],i=Ht(e);return t.forEach(o=>{const c=je(o.path);s.push(i.put({targetId:n,path:c})),s.push(this.referenceDelegate.addReference(e,n,o))}),S.waitFor(s)}removeMatchingKeys(e,t,n){const s=Ht(e);return S.forEach(t,i=>{const o=je(i.path);return S.waitFor([s.delete([n,o]),this.referenceDelegate.removeReference(e,n,i)])})}removeMatchingKeysForTargetId(e,t){const n=Ht(e),s=IDBKeyRange.bound([t],[t+1],!1,!0);return n.delete(s)}getMatchingKeysForTargetId(e,t){const n=IDBKeyRange.bound([t],[t+1],!1,!0),s=Ht(e);let i=ee();return s.ee({range:n,X:!0},(o,c,l)=>{const h=gt(o[1]),f=new F(h);i=i.add(f)}).next(()=>i)}containsKey(e,t){const n=je(t.path),s=IDBKeyRange.bound([n],[ff(n)],!1,!0);let i=0;return Ht(e).ee({index:Fc,X:!0,range:s},([o,c],l,h)=>{o!==0&&(i++,h.done())}).next(()=>i>0)}At(e,t){return lr(e).get(t).next(n=>n?ws(n):null)}}function lr(r){return Re(r,Sr)}function Fh(r){return Re(r,Vn)}function Ht(r){return Re(r,Rr)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kn="RemoteStore";class $E{constructor(e,t,n,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=i,this.Aa.Oo(o=>{n.enqueueAndForget(async()=>{Jn(this)&&(V(Kn,"Restarting streams for network reachability change."),await async function(l){const h=Q(l);h.Ea.add(4),await Hr(h),h.Ra.set("Unknown"),h.Ea.delete(4),await ri(h)}(this))})}),this.Ra=new qE(n,s)}}async function ri(r){if(Jn(r))for(const e of r.da)await e(!0)}async function Hr(r){for(const e of r.da)await e(!1)}function $m(r,e){const t=Q(r);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),ll(t)?cl(t):Kr(t).O_()&&al(t,e))}function ol(r,e){const t=Q(r),n=Kr(t);t.Ia.delete(e),n.O_()&&zm(t,e),t.Ia.size===0&&(n.O_()?n.L_():Jn(t)&&t.Ra.set("Unknown"))}function al(r,e){if(r.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(H.min())>0){const t=r.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Kr(r).Y_(e)}function zm(r,e){r.Va.Ue(e),Kr(r).Z_(e)}function cl(r){r.Va=new kI({getRemoteKeysForTarget:e=>r.remoteSyncer.getRemoteKeysForTarget(e),At:e=>r.Ia.get(e)||null,ht:()=>r.datastore.serializer.databaseId}),Kr(r).start(),r.Ra.ua()}function ll(r){return Jn(r)&&!Kr(r).x_()&&r.Ia.size>0}function Jn(r){return Q(r).Ea.size===0}function Gm(r){r.Va=void 0}async function zE(r){r.Ra.set("Online")}async function GE(r){r.Ia.forEach((e,t)=>{al(r,e)})}async function HE(r,e){Gm(r),ll(r)?(r.Ra.ha(e),cl(r)):r.Ra.set("Unknown")}async function KE(r,e,t){if(r.Ra.set("Online"),e instanceof um&&e.state===2&&e.cause)try{await async function(s,i){const o=i.cause;for(const c of i.targetIds)s.Ia.has(c)&&(await s.remoteSyncer.rejectListen(c,o),s.Ia.delete(c),s.Va.removeTarget(c))}(r,e)}catch(n){V(Kn,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await To(r,n)}else if(e instanceof Yi?r.Va.Ze(e):e instanceof lm?r.Va.st(e):r.Va.tt(e),!t.isEqual(H.min()))try{const n=await Um(r.localStore);t.compareTo(n)>=0&&await function(i,o){const c=i.Va.Tt(o);return c.targetChanges.forEach((l,h)=>{if(l.resumeToken.approximateByteSize()>0){const f=i.Ia.get(h);f&&i.Ia.set(h,f.withResumeToken(l.resumeToken,o))}}),c.targetMismatches.forEach((l,h)=>{const f=i.Ia.get(l);if(!f)return;i.Ia.set(l,f.withResumeToken(Ae.EMPTY_BYTE_STRING,f.snapshotVersion)),zm(i,l);const g=new St(f.target,l,h,f.sequenceNumber);al(i,g)}),i.remoteSyncer.applyRemoteEvent(c)}(r,t)}catch(n){V(Kn,"Failed to raise snapshot:",n),await To(r,n)}}async function To(r,e,t){if(!fn(e))throw e;r.Ea.add(1),await Hr(r),r.Ra.set("Offline"),t||(t=()=>Um(r.localStore)),r.asyncQueue.enqueueRetryable(async()=>{V(Kn,"Retrying IndexedDB access"),await t(),r.Ea.delete(1),await ri(r)})}function Hm(r,e){return e().catch(t=>To(r,t,e))}async function si(r){const e=Q(r),t=ln(e);let n=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:Dn;for(;WE(e);)try{const s=await CE(e.localStore,n);if(s===null){e.Ta.length===0&&t.L_();break}n=s.batchId,QE(e,s)}catch(s){await To(e,s)}Km(e)&&Wm(e)}function WE(r){return Jn(r)&&r.Ta.length<10}function QE(r,e){r.Ta.push(e);const t=ln(r);t.O_()&&t.X_&&t.ea(e.mutations)}function Km(r){return Jn(r)&&!ln(r).x_()&&r.Ta.length>0}function Wm(r){ln(r).start()}async function JE(r){ln(r).ra()}async function YE(r){const e=ln(r);for(const t of r.Ta)e.ea(t.mutations)}async function XE(r,e,t){const n=r.Ta.shift(),s=Qc.from(n,e,t);await Hm(r,()=>r.remoteSyncer.applySuccessfulWrite(s)),await si(r)}async function ZE(r,e){e&&ln(r).X_&&await async function(n,s){if(function(o){return NI(o)&&o!==C.ABORTED}(s.code)){const i=n.Ta.shift();ln(n).B_(),await Hm(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s)),await si(n)}}(r,e),Km(r)&&Wm(r)}async function Jh(r,e){const t=Q(r);t.asyncQueue.verifyOperationInProgress(),V(Kn,"RemoteStore received new credentials");const n=Jn(t);t.Ea.add(3),await Hr(t),n&&t.Ra.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await ri(t)}async function ew(r,e){const t=Q(r);e?(t.Ea.delete(2),await ri(t)):e||(t.Ea.add(2),await Hr(t),t.Ra.set("Unknown"))}function Kr(r){return r.ma||(r.ma=function(t,n,s){const i=Q(t);return i.sa(),new FE(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(r.datastore,r.asyncQueue,{Xo:zE.bind(null,r),t_:GE.bind(null,r),r_:HE.bind(null,r),H_:KE.bind(null,r)}),r.da.push(async e=>{e?(r.ma.B_(),ll(r)?cl(r):r.Ra.set("Unknown")):(await r.ma.stop(),Gm(r))})),r.ma}function ln(r){return r.fa||(r.fa=function(t,n,s){const i=Q(t);return i.sa(),new UE(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(r.datastore,r.asyncQueue,{Xo:()=>Promise.resolve(),t_:JE.bind(null,r),r_:ZE.bind(null,r),ta:YE.bind(null,r),na:XE.bind(null,r)}),r.da.push(async e=>{e?(r.fa.B_(),await si(r)):(await r.fa.stop(),r.Ta.length>0&&(V(Kn,`Stopping write stream with ${r.Ta.length} pending writes`),r.Ta=[]))})),r.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */tn(Kw,Ww,"app");function vg(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Qw=vg,Ag=new Qs("auth","Firebase",vg());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ci{constructor(e,t){this.shortDelay=e,this.longDelay=t,Vt(t>e,"Short delay should be less than long delay!"),this.isMobile=Hp()||Qp()}get(){return Xw()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ks(r,e,t=!1){if(t)return e;try{return await e}catch(n){throw n instanceof kt&&oT(n)&&r.auth.currentUser===r&&await r.auth.signOut(),n}}function oT({code:r}){return r==="auth/user-disabled"||r==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt extends li{constructor(){super("facebook.com")}static credential(e){return Wn._fromParams({providerId:Kt.PROVIDER_ID,signInMethod:Kt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Kt.credentialFromTaggedObject(e)}static credentialFromError(e){return Kt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Kt.credential(e.oauthAccessToken)}catch{return null}}}Kt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Kt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kg extends Gg{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Kg.type="SESSION";const Wg=Kg;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
