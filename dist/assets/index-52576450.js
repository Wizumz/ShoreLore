 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const At=new Sc("@firebase/app"),A_="@firebase/app-compat",b_="@firebase/analytics-compat",S_="@firebase/analytics",R_="@firebase/app-check-compat",P_="@firebase/app-check",C_="@firebase/auth",x_="@firebase/auth-compat",N_="@firebase/database",V_="@firebase/data-connect",D_="@firebase/database-compat",k_="@firebase/functions",M_="@firebase/functions-compat",O_="@firebase/installations",L_="@firebase/installations-compat",F_="@firebase/messaging",U_="@firebase/messaging-compat",B_="@firebase/performance",j_="@firebase/performance-compat",q_="@firebase/remote-config",$_="@firebase/remote-config-compat",z_="@firebase/storage",G_="@firebase/storage-compat",K_="@firebase/firestore",H_="@firebase/ai",W_="@firebase/firestore-compat",Q_="firebase",J_="12.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fr=J_;function Jd(r,e={}){let t=r;typeof e!="object"&&(e={name:e});const n={name:Wa,automaticDataCollectionEnabled:!0,...e},s=n.name;if(typeof s!="string"||!s)throw Jt.create("bad-app-name",{appName:String(s)});if(t||(t=Bd()),!t)throw Jt.create("no-options");const i=to.get(s);if(i){if(kn(t,i.options)&&kn(n,i.config))return i;throw Jt.create("duplicate-app",{appName:s})}const o=new o_(s);for(const l of Qa.values())o.addComponent(l);const c=new ey(t,n,o);return to.set(s,c),c}function Yd(r=Wa){const e=to.get(r);if(!e&&r===Wa&&Bd())return Jd();if(!e)throw Jt.create("no-app",{appName:r});return e}function Yt(r,e,t){let n=Y_[r]??r;t&&(n+=`-${t}`);const s=n.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const o=[`Unable to register library "${n}" with version "${e}":`];s&&o.push(`library name "${n}" contains illegal characters (whitespace or "/")`),s&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),At.warn(o.join(" "));return}Er(new Mn(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uy(r){Er(new Mn("platform-logger",e=>new w_(e),"PRIVATE")),Er(new Mn("heartbeat",e=>new oy(e),"PRIVATE")),Yt(Ha,Mu,r),Yt(Ha,Mu,"esm2020"),Yt("fire-js","")}uy("");var Bu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B(r,e,t){let n="Unexpected state";typeof e=="string"?n=e:t=e,af(r,n,t)}function af(r,e,t){let n=`FIRESTORE (${Ur}) INTERNAL ASSERTION FAILED: ${e} (ID: ${r.toString(16)})`;if(t!==void 0)try{n+=" CONTEXT: "+JSON.stringify(t)}catch{n+=" CONTEXT: "+t}throw qe(n),new Error(n)}function j(r,e,t,n){let s="Unexpected state";typeof t=="string"?s=t:n=t,r||af(e,s,n)}function K(r,e){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ro="";function Ue(r){let e="";for(let t=0;t<r.length;t++)e.length>0&&(e=Ju(e)),e=Cy(r.get(t),e);return Ju(e)}function Cy(r,e){let t=e;const n=r.length;for(let s=0;s<n;s++){const i=r.charAt(s);switch(i){case"\0":t+="";break;case ro:t+="";break;default:t+=i}}return t}function Ju(r){return r+ro+""}function ht(r){const e=r.length;if(j(e>=2,64408,{path:r}),e===2)return j(r.charAt(0)===ro&&r.charAt(1)==="",56145,{path:r}),oe.emptyPath();const t=e-2,n=[];let s="";for(let i=0;i<e;){const o=r.indexOf(ro,i);switch((o<0||o>t)&&B(50515,{path:r}),r.charAt(o+1)){case"":const c=r.substring(i,o);let l;s.length===0?l=c:(s+=c,l=s,s=""),n.push(l);break;case"":s+=r.substring(i,o),s+="\0";break;case"":s+=r.substring(i,o+1);break;default:B(61167,{path:r})}i=o+2}return new oe(n)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Of{}class te extends Of{constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}static create(e,t,n){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,n):new oI(e,t,n):t==="array-contains"?new lI(e,n):t==="in"?new qf(e,n):t==="not-in"?new uI(e,n):t==="array-contains-any"?new hI(e,n):new te(e,t,n)}static createKeyFieldInFilter(e,t,n){return t==="in"?new aI(e,n):new cI(e,n)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(rn(t,this.value)):t!==null&&nn(this.value)===nn(t)&&this.matchesComparison(rn(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return B(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class ce extends Of{constructor(e,t){super(),this.filters=e,this.op=t,this.Pe=null}static create(e,t){return new ce(e,t)}matches(e){return Cr(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function Cr(r){return r.op==="and"}function ic(r){return r.op==="or"}function Bc(r){return Lf(r)&&Cr(r)}function Lf(r){for(const e of r.filters)if(e instanceof ce)return!1;return!0}function oc(r){if(r instanceof te)return r.field.canonicalString()+r.op.toString()+Rr(r.value);if(Bc(r))return r.filters.map(e=>oc(e)).join(",");{const e=r.filters.map(t=>oc(t)).join(",");return`${r.op}(${e})`}}function Ff(r,e){return r instanceof te?function(n,s){return s instanceof te&&n.op===s.op&&n.field.isEqual(s.field)&&_t(n.value,s.value)}(r,e):r instanceof ce?function(n,s){return s instanceof ce&&n.op===s.op&&n.filters.length===s.filters.length?n.filters.reduce((i,o,c)=>i&&Ff(o,s.filters[c]),!0):!1}(r,e):void B(19439)}function Uf(r,e){const t=r.filters.concat(e);return ce.create(t,r.op)}function Bf(r){return r instanceof te?function(t){return`${t.field.canonicalString()} ${t.op} ${Rr(t.value)}`}(r):r instanceof ce?function(t){return t.op.toString()+" {"+t.getFilters().map(Bf).join(" ,")+"}"}(r):"Filter"}class oI extends te{constructor(e,t,n){super(e,t,n),this.key=F.fromName(n.referenceValue)}matches(e){const t=F.comparator(e.key,this.key);return this.matchesComparison(t)}}class aI extends te{constructor(e,t){super(e,"in",t),this.keys=jf("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class cI extends te{constructor(e,t){super(e,"not-in",t),this.keys=jf("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function jf(r,e){var t;return(((t=e.arrayValue)==null?void 0:t.values)||[]).map(n=>F.fromName(n.referenceValue))}class lI extends te{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return js(t)&&Us(t.arrayValue,this.value)}}class qf extends te{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&Us(this.value.arrayValue,t)}}class uI extends te{constructor(e,t){super(e,"not-in",t)}matches(e){if(Us(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!Us(this.value.arrayValue,t)}}class hI extends te{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!js(t)||!t.arrayValue.values)&&t.arrayValue.values.some(n=>Us(this.value.arrayValue,n))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jc(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ks(e)?"-0":e}}function Qf(r){return{integerValue:""+r}}function Jf(r,e){return Py(e)?Qf(e):jc(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bo{constructor(){this._=void 0}}function wI(r,e,t){return r instanceof xr?function(s,i){const o={fields:{[Cf]:{stringValue:Pf},[Nf]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Lc(i)&&(i=Lo(i)),i&&(o.fields[xf]=i),{mapValue:o}}(t,e):r instanceof Nr?Xf(r,e):r instanceof Vr?Zf(r,e):function(s,i){const o=Yf(s,i),c=dh(o)+dh(s.Ae);return sc(o)&&sc(s.Ae)?Qf(c):jc(s.serializer,c)}(r,e)}function vI(r,e,t){return r instanceof Nr?Xf(r,e):r instanceof Vr?Zf(r,e):t}function Yf(r,e){return r instanceof Dr?function(n){return sc(n)||function(i){return!!i&&"doubleValue"in i}(n)}(e)?e:{integerValue:0}:null}class xr extends Bo{}class Nr extends Bo{constructor(e){super(),this.elements=e}}function Xf(r,e){const t=em(e);for(const n of r.elements)t.some(s=>_t(s,n))||t.push(n);return{arrayValue:{values:t}}}class Vr extends Bo{constructor(e){super(),this.elements=e}}function Zf(r,e){let t=em(e);for(const n of r.elements)t=t.filter(s=>!_t(s,n));return{arrayValue:{values:t}}}class Dr extends Bo{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function dh(r){return fe(r.integerValue||r.doubleValue)}function em(r){return js(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HI{getBundleMetadata(e,t){return Ah(e).get(t).next(n=>{if(n)return function(i){return{id:i.bundleId,createTime:jn(i.createTime),version:i.version}}(n)})}saveBundleMetadata(e,t){return Ah(e).put(function(s){return{bundleId:s.id,createTime:Bn($e(s.createTime)),version:s.version}}(t))}getNamedQuery(e,t){return bh(e).get(t).next(n=>{if(n)return function(i){return{name:i.name,query:Em(i.bundledQuery),readTime:jn(i.readTime)}}(n)})}saveNamedQuery(e,t){return bh(e).put(function(s){return{name:s.name,readTime:Bn($e(s.readTime)),bundledQuery:s.bundledQuery}}(t))}}function Ah(r){return ve(r,ko)}function bh(r){return ve(r,Mo)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tm(r){var t,n;if(j(r instanceof te||r instanceof ce,20012),r instanceof te){if(r instanceof qf){const s=((n=(t=r.value.arrayValue)==null?void 0:t.values)==null?void 0:n.map(i=>te.create(r.field,"==",i)))||[];return ce.create(s,"or")}return r}const e=r.filters.map(s=>Tm(s));return ce.create(e,r.op)}function ZI(r){if(r.getFilters().length===0)return[];const e=gc(Tm(r));return j(wm(e),7391),fc(e)||mc(e)?[e]:e.getFilters()}function fc(r){return r instanceof te}function mc(r){return r instanceof ce&&Bc(r)}function wm(r){return fc(r)||mc(r)||function(t){if(t instanceof ce&&ic(t)){for(const n of t.getFilters())if(!fc(n)&&!mc(n))return!1;return!0}return!1}(r)}function gc(r){if(j(r instanceof te||r instanceof ce,34018),r instanceof te)return r;if(r.filters.length===1)return gc(r.filters[0]);const e=r.filters.map(n=>gc(n));let t=ce.create(e,r.op);return t=mo(t),wm(t)?t:(j(t instanceof ce,64498),j(Cr(t),40251),j(t.filters.length>1,57927),t.filters.reduce((n,s)=>Wc(n,s)))}function Wc(r,e){let t;return j(r instanceof te||r instanceof ce,38388),j(e instanceof te||e instanceof ce,25473),t=r instanceof te?e instanceof te?function(s,i){return ce.create([s,i],"and")}(r,e):xh(r,e):e instanceof te?xh(e,r):function(s,i){if(j(s.filters.length>0&&i.filters.length>0,48005),Cr(s)&&Cr(i))return Uf(s,i.getFilters());const o=ic(s)?s:i,c=ic(s)?i:s,l=o.filters.map(h=>Wc(h,c));return ce.create(l,"or")}(r,e),mo(t)}function xh(r,e){if(Cr(e))return Uf(e,r.getFilters());{const t=e.filters.map(n=>Wc(r,n));return ce.create(t,"or")}}function mo(r){if(j(r instanceof te||r instanceof ce,11850),r instanceof te)return r;const e=r.getFilters();if(e.length===1)return mo(e[0]);if(Lf(r))return r;const t=e.map(s=>mo(s)),n=[];return t.forEach(s=>{s instanceof te?n.push(s):s instanceof ce&&(s.op===r.op?n.push(...s.filters):n.push(s))}),n.length===1?n[0]:ce.create(n,r.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Oe.DEFAULT_COLLECTION_PERCENTILE=10,Oe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Oe.DEFAULT=new Oe(vm,Oe.DEFAULT_COLLECTION_PERCENTILE,Oe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Oe.DISABLED=new Oe(-1,0,0);class Go{constructor(e,t,n,s){this.userId=e,this.serializer=t,this.indexManager=n,this.referenceDelegate=s,this.Xn={}}static wt(e,t,n,s){j(e.uid!=="",64387);const i=e.isAuthenticated()?e.uid:"";return new Go(i,t,n,s)}checkEmpty(e){let t=!0;const n=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY]);return Ut(e).ee({index:Rn,range:n},(s,i,o)=>{t=!1,o.done()}).next(()=>t)}addMutationBatch(e,t,n,s){const i=dr(e),o=Ut(e);return o.add({}).next(c=>{j(typeof c=="number",49019);const l=new $c(c,t,n,s),h=function(R,x,V){const N=V.baseMutations.map(U=>ho(R.yt,U)),M=V.mutations.map(U=>ho(R.yt,U));return{userId:x,batchId:V.batchId,localWriteTimeMs:V.localWriteTime.toMillis(),baseMutations:N,mutations:M}}(this.serializer,this.userId,l),f=[];let g=new le((p,R)=>H(p.canonicalString(),R.canonicalString()));for(const p of s){const R=pf(this.userId,p.key.path,c);g=g.add(p.key.path.popLast()),f.push(o.put(h)),f.push(i.put(R,Ny))}return g.forEach(p=>{f.push(this.indexManager.addToCollectionParentIndex(e,p))}),e.addOnCommittedListener(()=>{this.Xn[c]=l.keys()}),S.waitFor(f).next(()=>l)})}lookupMutationBatch(e,t){return Ut(e).get(t).next(n=>n?(j(n.userId===this.userId,48,"Unexpected user for mutation batch",{userId:n.userId,batchId:t}),An(this.serializer,n)):null)}er(e,t){return this.Xn[t]?S.resolve(this.Xn[t]):this.lookupMutationBatch(e,t).next(n=>{if(n){const s=n.keys();return this.Xn[t]=s,s}return null})}getNextMutationBatchAfterBatchId(e,t){const n=t+1,s=IDBKeyRange.lowerBound([this.userId,n]);let i=null;return Ut(e).ee({index:Rn,range:s},(o,c,l)=>{c.userId===this.userId&&(j(c.batchId>=n,47524,{tr:n}),i=An(this.serializer,c)),l.done()}).next(()=>i)}getHighestUnacknowledgedBatchId(e){const t=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]);let n=Pn;return Ut(e).ee({index:Rn,range:t,reverse:!0},(s,i,o)=>{n=i.batchId,o.done()}).next(()=>n)}getAllMutationBatches(e){const t=IDBKeyRange.bound([this.userId,Pn],[this.userId,Number.POSITIVE_INFINITY]);return Ut(e).J(Rn,t).next(n=>n.map(s=>An(this.serializer,s)))}getAllMutationBatchesAffectingDocumentKey(e,t){const n=Bi(this.userId,t.path),s=IDBKeyRange.lowerBound(n),i=[];return dr(e).ee({range:s},(o,c,l)=>{const[h,f,g]=o,p=ht(f);if(h===this.userId&&t.path.isEqual(p))return Ut(e).get(g).next(R=>{if(!R)throw B(61480,{nr:o,batchId:g});j(R.userId===this.userId,10503,"Unexpected user for mutation batch",{userId:R.userId,batchId:g}),i.push(An(this.serializer,R))});l.done()}).next(()=>i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new le(H);const s=[];return t.forEach(i=>{const o=Bi(this.userId,i.path),c=IDBKeyRange.lowerBound(o),l=dr(e).ee({range:c},(h,f,g)=>{const[p,R,x]=h,V=ht(R);p===this.userId&&i.path.isEqual(V)?n=n.add(x):g.done()});s.push(l)}),S.waitFor(s).next(()=>this.rr(e,n))}getAllMutationBatchesAffectingQuery(e,t){const n=t.path,s=n.length+1,i=Bi(this.userId,n),o=IDBKeyRange.lowerBound(i);let c=new le(H);return dr(e).ee({range:o},(l,h,f)=>{const[g,p,R]=l,x=ht(p);g===this.userId&&n.isPrefixOf(x)?x.length===s&&(c=c.add(R)):f.done()}).next(()=>this.rr(e,c))}rr(e,t){const n=[],s=[];return t.forEach(i=>{s.push(Ut(e).get(i).next(o=>{if(o===null)throw B(35274,{batchId:i});j(o.userId===this.userId,9748,"Unexpected user for mutation batch",{userId:o.userId,batchId:i}),n.push(An(this.serializer,o))}))}),S.waitFor(s).next(()=>n)}removeMutationBatch(e,t){return Am(e.le,this.userId,t).next(n=>(e.addOnCommittedListener(()=>{this.ir(t.batchId)}),S.forEach(n,s=>this.referenceDelegate.markPotentiallyOrphaned(e,s))))}ir(e){delete this.Xn[e]}performConsistencyCheck(e){return this.checkEmpty(e).next(t=>{if(!t)return S.resolve();const n=IDBKeyRange.lowerBound(function(o){return[o]}(this.userId)),s=[];return dr(e).ee({range:n},(i,o,c)=>{if(i[0]===this.userId){const l=ht(i[1]);s.push(l)}else c.done()}).next(()=>{j(s.length===0,56720,{sr:s.map(i=>i.canonicalString())})})})}containsKey(e,t){return bm(e,this.userId,t)}_r(e){return Sm(e).get(this.userId).next(t=>t||{userId:this.userId,lastAcknowledgedBatchId:Pn,lastStreamToken:""})}}function bm(r,e,t){const n=Bi(e,t.path),s=n[1],i=IDBKeyRange.lowerBound(n);let o=!1;return dr(r).ee({range:i,X:!0},(c,l,h)=>{const[f,g,p]=c;f===e&&g===s&&(o=!0),h.done()}).next(()=>o)}function Ut(r){return ve(r,rt)}function dr(r){return ve(r,wr)}function Sm(r){return ve(r,Ms)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function To(r){r=Ve(r,ye);const e=Ve(r.firestore,et);return bT(zr(e),r._key).then(t=>yg(e,r,t))}Dn._jsonSchemaVersion="firestore/querySnapshot/1.0",Dn._jsonSchema={type:Ee("string",Dn._jsonSchemaVersion),bundleSource:Ee("string","QuerySnapshot"),bundleName:Ee("string"),bundle:Ee("string")};class bl extends jT{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ye(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ye(this.firestore,null,t)}}function Sl(r){r=Ve(r,Vt);const e=Ve(r.firestore,et),t=zr(e),n=new bl(e);return fg(r._query),ST(t,r._query).then(s=>new Dn(e,n,r,s))}function _g(r,e,t){r=Ve(r,ye);const n=Ve(r.firestore,et),s=pg(r.converter,e,t);return ta(n,[cg(Jo(n),"setDoc",r._key,s,r.converter!==null,t).toMutation(r._key,Fe.none())])}function ea(r,e,t,...n){r=Ve(r,ye);const s=Ve(r.firestore,et),i=Jo(s);let o;return o=typeof(e=Be(e))=="string"||e instanceof Qo?LT(i,"updateDoc",r._key,e,t,n):OT(i,"updateDoc",r._key,e),ta(s,[o.toMutation(r._key,Fe.exists(!0))])}function $T(r){return ta(Ve(r.firestore,et),[new qo(r._key,Fe.none())])}function Rl(r,e){const t=Ve(r.firestore,et),n=an(r),s=pg(r.converter,e);return ta(t,[cg(Jo(r.firestore),"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,Fe.exists(!1))]).then(()=>n)}function zT(r,...e){var l,h,f;r=Be(r);let t={includeMetadataChanges:!1,source:"default"},n=0;typeof e[n]!="object"||od(e[n])||(t=e[n++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(od(e[n])){const g=e[n];e[n]=(l=g.next)==null?void 0:l.bind(g),e[n+1]=(h=g.error)==null?void 0:h.bind(g),e[n+2]=(f=g.complete)==null?void 0:f.bind(g)}let i,o,c;if(r instanceof ye)o=Ve(r.firestore,et),c=Ys(r._key.path),i={next:g=>{e[n]&&e[n](yg(o,r,g))},error:e[n+1],complete:e[n+2]};else{const g=Ve(r,Vt);o=Ve(g.firestore,et),c=g._query;const p=new bl(o);i={next:R=>{e[n]&&e[n](new Dn(o,p,g,R))},error:e[n+1],complete:e[n+2]},fg(r._query)}return function(p,R,x,V){const N=new fl(V),M=new ul(R,N,x);return p.asyncQueue.enqueueAndForget(async()=>al(await Io(p),M)),()=>{N.Nu(),p.asyncQueue.enqueueAndForget(async()=>cl(await Io(p),M))}}(zr(o),c,s,i)}function ta(r,e){return function(n,s){const i=new ft;return n.asyncQueue.enqueueAndForget(async()=>dT(await wT(n),s,i)),i.promise}(zr(r),e)}function yg(r,e,t){const n=t.docs.get(e._key),s=new bl(r);return new Vn(r,s,e._key,n,new Es(t.hasPendingWrites,t.fromCache),e.converter)}function at(){return new pl("serverTimestamp")}function Wt(r){return new _l("increment",r)}(function(e,t=!0){(function(s){Ur=s})(Fr),Er(new Mn("firestore",(n,{instanceIdentifier:s,options:i})=>{const o=n.getProvider("app").getImmediate(),c=new et(new fy(n.getProvider("auth-internal")),new py(o,n.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new k(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Fn(h.options.projectId,f)}(o,s),o);return i={useFetchStreams:t,...i},c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),Yt(ju,qu,e),Yt(ju,qu,"esm2020")})();var GT="firebase",KT="12.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xw(r,e,t=!1){const{auth:n}=r;if(st(n.app))return Promise.reject(tn(n));const s="reauthenticate";try{const i=await zs(r,Bg(n,s,e,r),t);G(i.idToken,n,"internal-error");const o=xl(i.idToken);G(o,n,"internal-error");const{sub:c}=o;return G(r.uid===c,n,"user-mismatch"),cn._forOperation(r,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Rt(n,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nw(r,e,t=!1){if(st(r.app))return Promise.reject(tn(r));const n="signIn",s=await Bg(r,n,e),i=await cn._fromIdTokenResponse(r,n,s);return t||await r._updateCurrentUser(i.user),i}function Vw(r,e,t,n){return Be(r).onIdTokenChanged(e,t,n)}function Dw(r,e,t){return Be(r).beforeAuthStateChanged(e,t)}const So="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jg{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(So,"1"),this.storage.removeItem(So),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $g extends jg{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}$g.type="SESSION";const zg=$g;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gg(){return typeof pt().WorkerGlobalScope<"u"&&typeof pt().importScripts=="function"}async function Bw(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function jw(){var r;return((r=navigator==null?void 0:navigator.serviceWorker)==null?void 0:r.controller)||null}function qw(){return Gg()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ba="webStorageSupport";class Ov{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=zg,this._completeRedirectFn=ov,this._overrideRedirectResult=rv}async _openPopup(e,t,n,s){var o;Pt((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const i=await wd(e,t,n,Tc(),s);return xv(e,i,Dl())}async _openRedirect(e,t,n,s){await this._originValidation(e);const i=await wd(e,t,n,Tc(),s);return Uw(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(Pt(i,"If manager is not set, promise should be"),i)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch(()=>{delete this.eventManagers[t]}),n}async initAndGetManager(e){const t=await Av(e),n=new cv(e);return t.register("authEvent",s=>(G(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:n.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ba,{type:Ba},s=>{var o;const i=(o=s==null?void 0:s[0])==null?void 0:o[Ba];i!==void 0&&t(!!i),Rt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=fv(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Mg()||Cg()||Nl()}}const Lv=Ov;var vd="@firebase/auth",Ad="1.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=index-52576450.js.map
